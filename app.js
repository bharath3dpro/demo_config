...
// const buttons = [
//   { element: document.getElementById("kick"), sound: document.getElementById("kick-sound"), key: "a" },
//   { element: document.getElementById("ride"), sound: document.getElementById("ride-sound"), key: "s" },
//   { element: document.getElementById("snare"), sound: document.getElementById("snare-sound"), key: "d" },
//   { element: document.getElementById("tom"), sound: document.getElementById("tom-sound"), key: "f" },
//   { element: document.getElementById("hihat"), sound: document.getElementById("hihat-sound"), key: "g" }
// ];
...
// buttons.forEach(({ element, sound, key }) => {
//   element.addEventListener("click", () => playSound(sound));
// });

// document.addEventListener("keydown", (event) => {
//   const button = buttons.find((btn) => btn.key === event.key);
//   if (button) {
